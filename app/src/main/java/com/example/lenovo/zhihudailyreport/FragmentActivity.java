...
import com.example.lenovo.zhihudailyreport.Adapter.ViewPagerAdapter;
import com.example.lenovo.zhihudailyreport.Bean.News;
import com.example.lenovo.zhihudailyreport.Fragment.ColumnFragment;
import com.example.lenovo.zhihudailyreport.Fragment.NewsFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        headerView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (userName == null){
                    Intent intent = new Intent(FragmentActivity.this, Login.class);
                    startActivity(intent);
                }
                else {
                    if (ContextCompat.checkSelfPermission(FragmentActivity.this,
                            Manifest.permission.WRITE_EXTERNAL_STORAGE)!=PackageManager.PERMISSION_GRANTED){
                        ActivityCompat.requestPermissions(FragmentActivity.this,new
            ...
            public boolean onNavigationItemSelected(MenuItem item) {
                ...
                switch (item.getItemId()) {
                    case R.id.information:
                        if(userName == null){
                            Toast.makeText(FragmentActivity.this, "您还没有登录~请点击头像登录", Toast.LENGTH_SHORT).show();
                        }
                        else {
                            Intent intent = new Intent(FragmentActivity.this, Information.class);
                    ...
                    case R.id.like:
                        if(userName == null){
                            ...
                            Intent intent = new Intent(FragmentActivity.this, Like_news.class);
                            intent.putExtra("userName",userName);
                            startActivity(intent);
                        }
                        break;
                    case R.id.column:
                        if(userName == null){
                            ...
                            Intent intent = new Intent(FragmentActivity.this, Like_column.class);
                            intent.putExtra("userName",userName);
                            startActivity(intent);
                        }
                        break;
                    case R.id.change_password:
                        if(userName == null){
                            ...
                            Intent intent = new Intent(FragmentActivity.this, ChangePassword.class);
                            intent.putExtra("userName",userName);
                            startActivity(intent);
                        }
                        break;
                    case R.id.out:
                        if(userName == null){
                            ...
                            userName = null;
                            Toast.makeText(FragmentActivity.this, "已退出当前帐号", Toast.LENGTH_SHORT).show();
                            Intent intent = new Intent(FragmentActivity.this, FragmentActivity.class);
                            intent.putExtra("userName",userName);
                            startActivity(intent);
                        }
                        break;
                            ...
                            Snackbar.make(drawerLayout,"确定要注销吗",Snackbar.LENGTH_SHORT)
                                    .setAction("确定", new View.OnClickListener() {
                                        ...
                                        public void onClick(View v) {
                                            ...
                                            Toast.makeText(FragmentActivity.this, "已注销", Toast.LENGTH_SHORT).show();
                                            userName = null;
                                            Intent intent = new Intent(FragmentActivity.this, FragmentActivity.class);
                                            intent.putExtra("userName",userName);
                                            startActivity(intent);
